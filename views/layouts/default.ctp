...
<script type='text/javascript' src='//asset.mojohelpdesk.com/javascripts/form_widget.js'></script>
		...
		<header> 
			...
			<h1 style="margin:0px;"><?php echo $this->Html->link(__('Provoke One', true), '/', array('style' => 'display:block;text-indent:-9999px;width:320px;height:120px;')); ?></h1> 
			</div> 
			<!-- Absolute top nav -->
			<nav class="account">
		...
		<section id="main"  style="text-align:left;">
			...
			<!-- Start content -->
			<div style="<?php if(isset($menu)) { echo "width:746px;"; } else { echo ""; } ?> float: left; margin-bottom: 135px;">		
