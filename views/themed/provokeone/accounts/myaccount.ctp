<section id="account-details">
	...
	<span class="account-name"><?php echo $account['Account']['email']; ?></span> 
	<span class="edit">[<?php echo $this->Html->link(__('Edit', true), array('controller' => 'accounts', 'action' => 'changeEmail')); ?>]</span><br />
	<span class="edit">[<?php echo $this->Html->link(__('Change Your Password', true), array('controller' => 'accounts', 'action' => 'changePassword')); ?>]</span>
</section>
