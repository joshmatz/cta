...
<table>
	...
	<tr>
  	...
  	<tr>
    	...
    	echo $this->Js->submit('Submit', array('url'=> array('controller'=>'populations', 'action'=>'change'), 'update' => '#population', 'buffer' => false, 'before' => $this->Js->get('#spinner')->effect('fadeIn', array('buffer' => false)), 'complete' => $this->Js->get('#spinner')->effect('fadeOut', array('buffer' => false)) . $this->Js->get('.tooltip')->effect('fadeOut', array('buffer' => false)))); ?><center></td>
 	</tr>
 	<tr><td colspan="4">* Not including unit upkeep.<br />** Including Castle build rate <br />*** Estimated</td></tr>
</table></center></form>

<script type="text/javascript">$(".tips span[title]").tooltip({position: 'center right', offset: [0, 10], effect: 'slide'}).dynamic({ left: { direction: 'left', bounce: true } });</script>