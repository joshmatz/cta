...
<table width="100%">
	<tr>
		<td align="center" width="50%"><?php echo $paginator->prev('« Previous', array('class' => 'PrevPg'), null, array('class' => 'PrevPg DisabledPgLk')) ?></td>
		<td align="center" width="50%"><?php echo $paginator->next(' Next »', array('class' => 'NextPg'), null, array('class' => 'NextPg DisabledPgLk')); ?> </td>
	</tr>
</table>
<style type="text/css">
