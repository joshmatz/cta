...
<table align="center" width="100%">
	...
	<?php if($user['User']['honor_rank'] < $honor[0]['User']['honor_rank']) {?>
			<tr style="background-color: #CCCCCC;">
	    		...
	    		<td style="color: #AAA;"><a href="/users/profile/<?php echo $user['User']['id'] ?>" style="color:black;"><?php echo $user['User']['ruler']; ?></a></td>
	...
	<?php foreach($honor as $player): ?>
		<?php if($player['User']['id'] != $user['User']['id']) {?>
			<tr>
	    		...
	    		<td><a href="/users/profile/<?php echo $player['User']['id'] ?>"><?php echo $player['User']['ruler']; ?></a></td>
