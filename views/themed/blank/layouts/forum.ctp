...
<?php echo $this->Facebook->html(); ?>
	<head>
		...
		<script src="/js/markitup/sets/bbcode/set.js"></script>
	...
	<body lang="en">
		<header> 
			...
			<?php if(isset($menu) && $account['Account']['role'] == 'admin'): ?>
				<ul class="sub-submenu">
					<?php foreach($menu as $item): ?>
						<li class="sub-submenu_item <?php if(isset($selected)) { if($item['name'] == $selected) { echo "selected_item"; } } ?>"><a href="<?php echo $item['link'] ?>"><?php echo $item['name'] ?></a>
					<?php endforeach; ?>
				</ul>
			<?php endif;?>
